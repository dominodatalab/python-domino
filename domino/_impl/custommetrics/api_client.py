...
from domino._impl.custommetrics import rest
from domino._impl.custommetrics.configuration import Configuration
from domino._impl.custommetrics.exceptions import ApiTypeError, ApiValueError
from domino._impl.custommetrics.schemas import (
    BinarySchema,
    BoolClass,
    FileIO,
    NoneClass,
...
class RequestBody(StyleFormSerializer, JSONDetector):
    ...
    def __serialize_application_x_www_form_data(
        ...
        value = self._serialize_form(
            cast_in_data, name="", explode=True, percent_encode=False
        )
