...
class NewMetricValueV1(schemas.DictSchema):
        ...
        class properties:
            ...
            class tags(schemas.ListSchema):
                ...
                def __new__(
                    cls,
                    arg: typing.Union[
                        typing.Tuple["MetricTagV1"], typing.List["MetricTagV1"]
                    ],
    ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["modelMonitoringId"]
    ) -> MetaOapg.properties.modelMonitoringId: ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["metric"]
    ) -> MetaOapg.properties.metric: ...
    @typing.overload
    def __getitem__(
    ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["referenceTimestamp"]
    ) -> MetaOapg.properties.referenceTimestamp: ...
    @typing.overload
    def __getitem__(
    ...
    def __new__(
        ...
        *args: typing.Union[
        ...
        tags: typing.Union[
            MetaOapg.properties.tags, list, tuple, schemas.Unset
        ] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[
