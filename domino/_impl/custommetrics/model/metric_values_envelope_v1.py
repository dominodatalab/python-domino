...
class MetricValuesEnvelopeV1(schemas.DictSchema):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class metricValues(schemas.ListSchema):
                ...
                def __new__(
                    cls,
                    arg: typing.Union[
                        typing.Tuple["MetricValueV1"], typing.List["MetricValueV1"]
                    ],
    ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["metricValues"]
    ) -> MetaOapg.properties.metricValues: ...
