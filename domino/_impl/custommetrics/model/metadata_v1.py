...
class MetadataV1(schemas.DictSchema):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class notices(schemas.ListSchema):
    ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["requestId"]
    ) -> MetaOapg.properties.requestId: ...

    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["notices"]
    ) -> MetaOapg.properties.notices: ...
