...
def test_list_models(default_domino_client):
    ...
    assert models_list["objectType"] == "list", \
...
def test_publish_a_model(default_domino_client):
    ...
    model = default_domino_client.model_publish(filename, function, env_id,
...
def test_publish_model_version(default_domino_client):
    ...
    new_version = default_domino_client.model_version_publish(model_id, filename, function, env_id,
                                                              model_name, model_description)
