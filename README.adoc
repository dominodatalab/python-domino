...
NOTE: for git-based projects, this pins the project's internal DFS commit, not a commit on the main git repository — passing a commit SHA from the main repository here will fail.
