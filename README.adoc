...
[[module-domino.aisystems.environment_variables]]
...
DOMINO++_++AI++_++SYSTEM++_++CONFIG++_++PATH[.colon]##:##::
  For configuring the location of the ai++_++system++_++config.yaml
  file. If not set, defaults to ‘./ai++_++system++_++config.yaml’.
type[.colon]##:##::
  str
DOMINO++_++AI++_++SYSTEM++_++MODEL++_++ID[.colon]##:##::
  The ID of the production AI System
type[.colon]##:##::
  str

[[module-domino.aisystems.logging]]
...
[cols=",",]
|===
|link:#domino.aisystems.logging.log_evaluation[[.pre]#`log++_++evaluation`#](trace++_++id, name, value)
...
[cols=",",]
|===
|link:#domino.aisystems.logging.DominoRun[[.pre]#`DominoRun`#](++[++experiment++_++name, run++_++id, ...++]++)
...
traces made during the run.
|===

_[.pre]#class#[.w]#
#_[.sig-prename .descclassname]#[.pre]#domino.aisystems.logging.##[.sig-name .descname]#[.pre]#DominoRun##[.sig-paren]#(#_[.n]#[.pre]#experiment++_++name##[.o]#[.pre]#=##[.default_value]#[.pre]#None##_,
_[.n]#[.pre]#run++_++id##[.o]#[.pre]#=##[.default_value]#[.pre]#None##_,
_[.n]#[.pre]#ai++_++system++_++config++_++path##[.o]#[.pre]#=##[.default_value]#[.pre]#None##_,
_[.n]#[.pre]#custom++_++summary++_++metrics##[.o]#[.pre]#=##[.default_value]#[.pre]#None##_[.sig-paren]#)#link:#domino.aisystems.logging.DominoRun[¶]::
  Bases: [.pre]#`object`#
  +
  DominoRun is a context manager that starts an Mlflow run and attaches
  the user’s AI System configuration to it, create a Logged Model with
  the AI System configuration, and computes summary metrics for
  evaluation traces made during the run. Average metrics are computed by
  default, but the user can provide a custom list of evaluation metric
  aggregators. This is intended to be used in development mode for AI
  System evaluation. Context manager docs:
  https://docs.python.org/3/library/contextlib.html
  +
  Parallelism: DominoRun is not thread-safe. Runs in different threads
  will work correctly. This is due to Mlflow’s architecture.
  Parallelizing operations within a single DominoRun context however, is
  supported.
  +
  Example
  +
  ...
  +
  Parameters[.colon]##:##;;
    * *experiment++_++name* (_Optional++[++str++]++_) – the name of the
    mlflow experiment to log the run to.
    * *run++_++id* (_Optional++[++str++]++_) – optional, the ID of the
    mlflow run to continue logging to. If not provided a new run will
    start.
    * *ai++_++system++_++config++_++path* (_Optional++[++str++]++_) –
    the optional path to the AI System configuraiton file. If not
    provided, defaults to the
    ...
    * *custom++_++summary++_++metrics* (_Optional++[++list++[++str,_
    ...
    _'min'++]++++]++++]++_) – an optional list of tuples that define
    what summary statistic to use with what evaluation metric.
    * *are* (_Valid summary statistics_) – “mean”, “median”, “stdev”,
    “max”, “min” e.g. ++[++(“hallucination++_++rate”, “max”)++]++
  +
  Returns: DominoRun context manager

[.sig-prename .descclassname]#[.pre]#domino.aisystems.logging.##[.sig-name .descname]#[.pre]#log++_++evaluation##[.sig-paren]#(#_[.n]#[.pre]#trace++_++id##_,
_[.n]#[.pre]#name##_,
_[.n]#[.pre]#value##_[.sig-paren]#)#link:#domino.aisystems.logging.log_evaluation[¶]::
  This logs evaluation data and metdata to a parent trace. This is used
  to log the evaluation of a span after it was created. This is useful
  for analyzing past performance of an AI System component.
  +
  Parameters[.colon]##:##;;
    * *trace++_++id* (_str_) – the ID of the trace to evaluate
    * *name* (_str_) – an label for the evaluation result. This is used
    to identify the evaluation result
    * *value* (_float_ _++|++_ _str_) – the evaluation result to log.
    This must be a float or string


[[domino-aisystems-read-ai-system-config]]
== domino.aisystems.read++_++ai++_++system++_++configlink:#domino-aisystems-read-ai-system-config[¶]

[.sig-prename .descclassname]#[.pre]#domino.aisystems.##[.sig-name .descname]#[.pre]#read++_++ai++_++system++_++config##[.sig-paren]#(#_[.n]#[.pre]#path##[.o]#[.pre]#=##[.default_value]#[.pre]#None##_[.sig-paren]#)#link:#domino.aisystems.read_ai_system_config[¶]::
  For getting the ai++_++system++_++config.yaml file and reading it into
  a dictionary. If no path is provided it will look for the path in the
  DOMINO++_++AI++_++SYSTEM++_++CONFIG++_++PATH. See environment
  variables docs for default values.
  +
  Parameters[.colon]##:##;;
    *path* (_Optional++[++str++]++_) – Location of the ai system config
    yaml file.
  Returns[.colon]##:##;;
...
[[module-domino.aisystems.tracing]]
...
[cols=",",]
|===
|link:#domino.aisystems.tracing.add_tracing[[.pre]#`add++_++tracing`#](name++[++, autolog++_++frameworks, ...++]++)
|A decorator that starts an mlflow span for the function it decorates.

|link:#domino.aisystems.tracing.init_tracing[[.pre]#`init++_++tracing`#](++[++autolog++_++frameworks++]++)
|Initialize Mlflow autologging for various frameworks and set the active
model for production evaluation runs.

|link:#domino.aisystems.tracing.search_traces[[.pre]#`search++_++traces`#](run++_++id++[++, trace++_++name, ...++]++)
...
[cols=",",]
|===
|link:#domino.aisystems.tracing.SearchTracesResponse[[.pre]#`SearchTracesResponse`#](data, page++_++token)
|The response from searching for traces.

|link:#domino.aisystems.tracing.SpanSummary[[.pre]#`SpanSummary`#](id, name, trace++_++id, inputs, outputs)
|A span in a trace.

|link:#domino.aisystems.tracing.TraceSummary[[.pre]#`TraceSummary`#](name, id, spans, evaluation++_++results)
|A summary of a trace.
|===

[.sig-prename .descclassname]#[.pre]#domino.aisystems.tracing.##[.sig-name .descname]#[.pre]#add++_++tracing##[.sig-paren]#(#_[.n]#[.pre]#name##_,
_[.n]#[.pre]#autolog++_++frameworks##[.o]#[.pre]#=##[.default_value]#[.pre]#++[]++##_,
_[.n]#[.pre]#evaluator##[.o]#[.pre]#=##[.default_value]#[.pre]#None##_,
_[.n]#[.pre]#eagerly++_++evaluate++_++streamed++_++results##[.o]#[.pre]#=##[.default_value]#[.pre]#True##_[.sig-paren]#)#link:#domino.aisystems.tracing.add_tracing[¶]::
  A decorator that starts an mlflow span for the function it decorates.
  If there is an existing trace this span will be appended to it.
  +
  ...
  formatting what’s on the trace and the evaluation result inputs, which
  can be used by client’s to extract relevant data when analyzing a
  trace.
  +
  ...
  +
  @add++_++tracing(;;
    name=”assistant++_++chat++_++bot”,
    evaluator=evaluate++_++helpfulness,
  +
  ...
  +
  Parameters[.colon]##:##;;
    * *name* (_str_) – the name of the span to add to existing trace or
    create if no trace exists yet.
    * *autolog++_++frameworks* (_Optional++[++list++[++str++]++++]++_) –
    an optional list of mlflow supported frameworks to autolog
    * *evaluator* (_Optional++[++Callable++[++++[++T,_ _T++]++,_
    _dict++[++str,_ _int_ _++|++_ _float_ _++|++_ _str++]++++]++++]++_)
    – an optional function that takes the inputs and outputs of the
    wrapped function and returns
    * *tags.* (_a dictionary of evaluation results. The evaluation
    result will be added to the trace as_) –
    * *eagerly++_++evaluate++_++streamed++_++results* (_bool_) –
    optional boolean, defaults to true, this determines if all yielded
    values should be aggregated and set as outputs to a single span.
    This makes evaluation eaiser, but will impact performance if you
    expect a large number of streamed values. If set to false, each
    yielded value will generate a new span on the trace, which can be
    evaluated post-hoc. Inline evaluators won’t be executed. Each span
    will have a group++_++id set in their attributes to indicate that
    they are part of the same function call. Each span will have an
    index to indicate what order they arrived in.
  Returns[.colon]##:##;;
    A decorator that wraps the function to be traced.

_[.pre]#class#[.w]#
#_[.sig-prename .descclassname]#[.pre]#domino.aisystems.tracing.##[.sig-name .descname]#[.pre]#SpanSummary##[.sig-paren]#(#_[.n]#[.pre]#id##_,
_[.n]#[.pre]#name##_, _[.n]#[.pre]#trace++_++id##_,
_[.n]#[.pre]#inputs##_,
_[.n]#[.pre]#outputs##_[.sig-paren]#)#link:#domino.aisystems.tracing.SpanSummary[¶]::
  Bases: [.pre]#`object`#
  +
  A span in a trace.
  +
  Parameters[.colon]##:##;;
    * *id* (_str_) – The mlflow ID of the span
    * *name* (_str_) – The name of the span
    * *trace++_++id* (_str_) – The span’s parent trace ID
    * *inputs* (_Any_) – The inputs to the function that created the
    span
    * *outputs* (_Any_) – The outputs to the function that created the
    span
  +
  [.sig-name .descname]#[.pre]#id##_[.p]#[.pre]#:##[.w]#
  #[.pre]#str#_link:#domino.aisystems.tracing.SpanSummary.id[¶];;
  +
  [.sig-name .descname]#[.pre]#name##_[.p]#[.pre]#:##[.w]#
  #[.pre]#str#_link:#domino.aisystems.tracing.SpanSummary.name[¶];;
  +
  [.sig-name .descname]#[.pre]#trace++_++id##_[.p]#[.pre]#:##[.w]#
  #[.pre]#str#_link:#domino.aisystems.tracing.SpanSummary.trace_id[¶];;
  +
  [.sig-name .descname]#[.pre]#inputs##_[.p]#[.pre]#:##[.w]#
  #[.pre]#Any#_link:#domino.aisystems.tracing.SpanSummary.inputs[¶];;
  +
  [.sig-name .descname]#[.pre]#outputs##_[.p]#[.pre]#:##[.w]#
  #[.pre]#Any#_link:#domino.aisystems.tracing.SpanSummary.outputs[¶];;

_[.pre]#class#[.w]#
#_[.sig-prename .descclassname]#[.pre]#domino.aisystems.tracing.##[.sig-name .descname]#[.pre]#TraceSummary##[.sig-paren]#(#_[.n]#[.pre]#name##_,
_[.n]#[.pre]#id##_, _[.n]#[.pre]#spans##_,
_[.n]#[.pre]#evaluation++_++results##_[.sig-paren]#)#link:#domino.aisystems.tracing.TraceSummary[¶]::
  Bases: [.pre]#`object`#
  +
  A summary of a trace.
  +
  Parameters[.colon]##:##;;
    * *id* (_str_) – The mlflow ID of the trace
    * *name* (_str_) – The name of the trace
    * *spans*
  ...
  +
  [.sig-name .descname]#[.pre]#name##_[.p]#[.pre]#:##[.w]#
  #[.pre]#str#_link:#domino.aisystems.tracing.TraceSummary.name[¶];;
  +
  [.sig-name .descname]#[.pre]#id##_[.p]#[.pre]#:##[.w]#
  #[.pre]#str#_link:#domino.aisystems.tracing.TraceSummary.id[¶];;
  +
  [.sig-name .descname]#[.pre]#spans##_[.p]#[.pre]#:##[.w]#
  #[.pre]#list#[.p]#[.pre]#++[++##link:domino.aisystems.tracing.tracing.html#domino.aisystems.tracing.tracing.SpanSummary[[.pre]#domino.aisystems.tracing.tracing.SpanSummary#][.p]#[.pre]#++]++##_link:#domino.aisystems.tracing.TraceSummary.spans[¶];;
  +
  [.sig-name .descname]#[.pre]#evaluation++_++results##_[.p]#[.pre]#:##[.w]#
  #[.pre]#list#[.p]#[.pre]#++[++##link:domino.aisystems.tracing.tracing.html#domino.aisystems.tracing.tracing.EvaluationResult[[.pre]#domino.aisystems.tracing.tracing.EvaluationResult#][.p]#[.pre]#++]++##_link:#domino.aisystems.tracing.TraceSummary.evaluation_results[¶];;

_[.pre]#class#[.w]#
#_[.sig-prename .descclassname]#[.pre]#domino.aisystems.tracing.##[.sig-name .descname]#[.pre]#SearchTracesResponse##[.sig-paren]#(#_[.n]#[.pre]#data##_,
_[.n]#[.pre]#page++_++token##_[.sig-paren]#)#link:#domino.aisystems.tracing.SearchTracesResponse[¶]::
  Bases: [.pre]#`object`#
  +
  The response from searching for traces.
  +
  Parameters[.colon]##:##;;
    ...
    * *page++_++token* (_Optional++[++str++]++_) – The token to provide
    to the api to get the next page of results
    * *data*
    ...
    –
  +
  [.sig-name .descname]#[.pre]#data##_[.p]#[.pre]#:##[.w]#
  #[.pre]#list#[.p]#[.pre]#++[++##link:domino.aisystems.tracing.tracing.html#domino.aisystems.tracing.tracing.TraceSummary[[.pre]#domino.aisystems.tracing.tracing.TraceSummary#][.p]#[.pre]#++]++##_link:#domino.aisystems.tracing.SearchTracesResponse.data[¶];;
  +
  [.sig-name .descname]#[.pre]#page++_++token##_[.p]#[.pre]#:##[.w]#
  #[.pre]#Optional#[.p]#[.pre]#++[++##[.pre]#str#[.p]#[.pre]#++]++##_link:#domino.aisystems.tracing.SearchTracesResponse.page_token[¶];;

[.sig-prename .descclassname]#[.pre]#domino.aisystems.tracing.##[.sig-name .descname]#[.pre]#search++_++traces##[.sig-paren]#(#_[.n]#[.pre]#run++_++id##_,
_[.n]#[.pre]#trace++_++name##[.o]#[.pre]#=##[.default_value]#[.pre]#None##_,
_[.n]#[.pre]#start++_++time##[.o]#[.pre]#=##[.default_value]#[.pre]#None##_,
_[.n]#[.pre]#end++_++time##[.o]#[.pre]#=##[.default_value]#[.pre]#None##_,
_[.n]#[.pre]#page++_++token##[.o]#[.pre]#=##[.default_value]#[.pre]#None##_,
_[.n]#[.pre]#max++_++results##[.o]#[.pre]#=##[.default_value]#[.pre]#None##_[.sig-paren]#)#link:#domino.aisystems.tracing.search_traces[¶]::
  This allows searching for traces that have a certain name and returns
  a paginated response of trace summaries that inclued the spans that
  were requested.
  +
  Parameters[.colon]##:##;;
    * *run++_++id* (_str_) – string, the ID of the development mode
    evaluation run to search for traces.
    * *trace++_++name* (_Optional++[++str++]++_) – optinoal, the name of
    the traces to search for
    * *start++_++time* (_Optional++[++datetime++]++_) – optional python
    datetime
    * *end++_++time* (_Optional++[++datetime++]++_) – optional python
    datetime, defaults to now
    * *page++_++token* (_Optional++[++str++]++_) – optional page token
    for pagination. You can use this to request the next page of results
    and may find a page++_++token in the response of the previous
    search++_++traces call.
    * *max++_++results* (_Optional++[++int++]++_) – optional, defaults
    to 100
  Returns[.colon]##:##;;
...
[.sig-prename .descclassname]#[.pre]#domino.aisystems.tracing.##[.sig-name .descname]#[.pre]#init++_++tracing##[.sig-paren]#(#_[.n]#[.pre]#autolog++_++frameworks##[.o]#[.pre]#=##[.default_value]#[.pre]#None##_[.sig-paren]#)#link:#domino.aisystems.tracing.init_tracing[¶]::
  Initialize Mlflow autologging for various frameworks and set the
  active model for production evaluation runs. This may be used to
  initialize logging and tracing for the AI System in dev and prod
  modes. If in prod mode, a DOMINO++_++AI++_++SYSTEM++_++MODEL++_++ID is
  required and represents the production AI System component. All traces
  will be linked to that model. No run is required.
  +
  Parameters[.colon]##:##;;
    *autolog++_++frameworks* (_Optional++[++list++[++str++]++++]++_) –
    list of frameworks to autolog
