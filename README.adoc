...
DOMINO++_++AI++_++SYSTEM++_++IS++_++PROD: +
...
=== _class_ domino.aisystems.tracing.EvaluationResult(_name: str_, _value:float ++|++ str_) +
Bases: `object`
