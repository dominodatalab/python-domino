...
You can also add `python-domino` to your `requirements.txt` file with the following syntax:
    ...
    -f git+git://github.com/dominodatalab/python-domino.git@1.0.4
...
```
pip install -e git+https://github.com/dominodatalab/python-domino.git@1.0.4#egg=python-domino[airflow]
```
